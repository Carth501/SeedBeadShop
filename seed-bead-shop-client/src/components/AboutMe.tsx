...
const AboutMe: React.FC = () => {
	return (
		<div className="about-me p-16 mt-8 dark:border-uranian-blue bg-uranian-blue text-carribean-current dark:bg-carribean-current dark:text-uranian-blue font-semibold flex items-center justify-center">
			<div className="w-2/3">
