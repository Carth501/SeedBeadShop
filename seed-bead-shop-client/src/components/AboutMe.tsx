...
const AboutMe: React.FC = () => {
	return (
		<div className="about-me p-16 mt-8 border-t border-gray-300 dark:border-uranian-blue bg-carribean-current text-white font-semibold flex items-center justify-center">
			<div className="w-2/3">
